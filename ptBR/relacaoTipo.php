...
<html lang="pt-BR">
    ...
    <?php
        if (count($_POST) > 0) {
            ...
            while ($linha = mysqli_fetch_assoc($rs)) {
                ...
                echo "<tr id='idTabela'>
                        <td>$cod</td>
                        <td>$desc</td>
                        <td><a href='relacaoTipo.php?op=E&codigo=$cod' onclick='Mudarestado('minhaDiv')'><img src='../images/icons8-editar-vários-50.png'</a></td>
                        <td><a href='relacaoTipo.php?op=X&codigo=$cod'><img src='../images/icons8-lixo-50.png'</a></td>
                    </tr>";
                echo "</center>";
            }
        }
        ...
        <?php  include '../inc/PTeditarTipo.inc'; ?>
</body>
</html>